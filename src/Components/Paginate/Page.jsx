...
const Page = ({ cardsPerPage, currentPage, setCurrentPage, totalCars }) => {
  const pageNumbers = [];
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.p}>de {pageNumbers.length}</p>
      <button
