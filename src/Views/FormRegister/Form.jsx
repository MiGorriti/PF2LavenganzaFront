      ...
      <div className="container mx-auto flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-black rounded-xl shadow-lg overflow-hidden mt-4 relative">
        ...
        <div className="w-full lg:w-1/2 py-8 px-12 text-white">
          ...
          >
            ...
            <button className="w-full bg-purple-500 py-3 text-center text-darkblue rounded hover:bg-purple-700 focus:outline-none mb-4">
              Sign Up
            </button>
              <GoogleLogin
                clientId={clientID}
          ...
          <div className="text-center">
            <p className="text-white mt-6">
              Have an account? <a href="#" className="text-purple-500 font-semibold">Log in here</a>.
            </p>
          </div>
        </div>
      </div>
