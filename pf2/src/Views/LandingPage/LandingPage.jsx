      ...
      <div className={styles.content}>
        <div className={styles.leftColumn} style={{ marginTop: "100px" }}>
          ...
          <section className={styles.chartSection}>
            <div className={styles.box1}>
              <p class="text-black" className={styles.chartItem1}>
                + 17K Satisfied Customers
              </p>
            </div>
            ...
            <div className={styles.box3}>
              <p class="text-black" className={styles.chartItem3}>
                + 25 Property Collections
              </p>
            </div>
            <div class='text-center' className={styles.box4}>
              <p class="text-black text-center" className={styles.chartItem4}>+ 100 Destinations to Stay</p>
            </div>
          </section>
        ...
        <div className={styles.rightColumn} style={{ marginTop: "100px" }}>
          ...
          <section className={styles.comments}>
            ...
            <p>
              I love this app! It made finding my dream rental home so easy and
              stress-free.
            </p>
            <p>
              The search filters are fantastic. I could narrow down exactly what
              I was looking for!
            </p>
            <p>
              Amazing customer service! They were quick to respond to my queries
              and very helpful.
            </p>
            <p>
              I found my new home within days of using this app. Thank you for
              the great service!
            </p>
          </section>
